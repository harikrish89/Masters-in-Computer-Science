...
/**  begin syscall sigaction comment for signal handling 
     #include <signal.h>
     ...
     sigdelset		(sigset_t *mask, int SIGNAL);
          ...
          SIGTERM 	15 	software termination signal
             ...
             ..... etc., * indicates core dump

************* end syscall sigaction comment ******/
...
************* end syscall semget comment ******/
   ...
   for(i=0; i<NUMSEMIDS; i++){
      if ((semid[i] = semget (SHMKEY+i, NUMFLAVORS, 
			            IPC_CREAT | 0600)) == -1){
...
/* Producer Start Producing Numbers Of Donuts */
   ...
   while(1){
     ...
     printf("donut_types = %d, In_ptr =  %d, serial =  %d\n",
                j, in_ptr[j], serial[j]);
